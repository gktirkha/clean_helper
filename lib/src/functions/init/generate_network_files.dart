...
void generateNetworkFiles() {
  writeFile('lib/core/network/constants/api_paths.dart', coreApiPathsTemplate());
  writeFile('lib/core/domain/entities/error_entity.dart', errorEntityTemplate());
  writeFile('lib/core/data/models/error_model.dart', errorModelTemplate());
  writeFile('lib/core/network/interceptors/error_interceptor.dart', errorInterceptorTemplate());
